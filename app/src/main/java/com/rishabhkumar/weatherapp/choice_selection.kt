...
class choice_selection : AppCompatActivity() {
    ...
    lateinit var btnWithGPS : Button
    lateinit var edtCity : EditText
    lateinit var btnWithCityName : Button

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_choice_selection)

        btnWithGPS = findViewById(R.id.btnGPS)
        edtCity = findViewById(R.id.edtCityName)
        btnWithCityName = findViewById(R.id.btnGo)


        btnWithGPS.setOnClickListener{
